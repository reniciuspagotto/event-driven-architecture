...
namespace EventDrivenArchitectureExample.Order
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EventDrivenArchitectureExample.Order", Version = "v1" });
            });
            ...
            services.AddHostedService<ProcessCancelOrderConsumer>();
            services.AddHostedService<ProcessFinalizeOrderConsumer>();
        }
